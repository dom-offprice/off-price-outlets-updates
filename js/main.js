...
(function initSaleUrgency() {
    ...
    if (countdownEl) {
        ...
        countdownEl.innerHTML =
            '<span class="hero-countdown-label">Next sale dates coming soon — stay tuned.</span>' +
            '<span class="visually-hidden" id="sale-countdown-live" aria-live="polite">Next sale dates coming soon. Follow us for the date.</span>';
    }
